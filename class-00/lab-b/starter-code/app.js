...
// This is a refrence to the Student Object & when we call it, it returns the properties of that object.
// 2. What is "this" when joe.scopeArrow() is invoked?
//It returns something different. Not sure what I am looking at in the console.log but it seems to be that it returns a window object with its properties. It does not refrence the Student Object. 
// 3. Explain why "this" is different when an arrow function is used.
//It is different because the scope bubbles down to the next-nearest cope when you use the arrow function notation. Because of this, it does not do a good job at accessing constructor objects and their properties when using 'this'.
