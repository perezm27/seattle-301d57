...
function displayPics(){
  ...
  // We got an error because rando is being locallly declared and the console log is refrencing this variable outside the declaration function. Which means it has no access to the variable.
  console.log(viewed);
